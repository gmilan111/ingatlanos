...
!function (t, e) {
    ...
    const zt = t => {
            ...
            if (!e || "#" === e) {
                ...
                i.includes("#") && !i.startsWith("#") && (i = `#${i.split("#")[1]}`), e = i && "#" !== i ? H(i.trim()) : null
            }
            return e
        }, Rt = {
            find: (t, e = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(e, t)),
    ...
    class Xo extends Bo {
        ...
        _getElements(t) {
            if (t && (this._element = t.target.parentNode, this._label = S.findOne("label", this._element)), t && this._label) {
    ...
    const ha = (t, e) => {
        ...
        dropdown: {
            name: "Dropdown", selector: "[data-mdb-dropdown-init]", isToggler: !0, callback: (t, e) => {
                ...
                D.on(document, n, o, r.dataApiKeydownHandler), D.on(document, n, ".dropdown-menu", r.dataApiKeydownHandler), D.on(document, i, r.clearMenus), D.on(document, s, r.clearMenus), D.on(document, i, o, (function (t) {
        ...
        input: {
            name: "Input", selector: "[data-mdb-input-init]", isToggler: !0, callback: (t, e) => {
                ...
                D.on(document, "focus", n, o.activate(new o)), D.on(document, "input", n, o.activate(new o)), D.on(document, "blur", n, o.deactivate(new o)), D.on(document, "focus", s, o.activate(new o)), D.on(document, "input", s, o.activate(new o)), D.on(document, "blur", s, o.deactivate(new o)), D.on(window, "shown.bs.modal", (t => {
                ...
                })), S.find(i).map((t => new o(t))), D.on(window, "reset", (t => {
                    S.find(n, t.target).forEach((t => {
                        const e = o.getInstance(t.parentNode);
                        e && e.forceInactive()
                    })), S.find(s, t.target).forEach((t => {
        ...
        ripple: {name: "Ripple", selector: "[data-mdb-ripple-init]", isToggler: !0, callback: ha},
        popover: {name: "Popover", selector: "[data-mdb-popover-init]", isToggler: !1, callback: ha}
    }, ua = new class {
        constructor(t) {
            i(this, "init", (t => {
                t.forEach((t => At(t)))
    ...
    ua({
        ...
        Tooltip: Eo,
        Range: ca
    }), t.Alert = Te, t.Button = Ht, t.Carousel = ii, t.Collapse = dr, t.Dropdown = Kr, t.Input = Xo, t.Modal = wi, t.Offcanvas = be, t.Popover = Ts, t.Range = ca, t.Ripple = oa, t.ScrollSpy = Ws, t.Tab = vo, t.Toast = Ro, t.Tooltip = Eo, t.initMDB = ua, Object.defineProperty(t, Symbol.toStringTag, {value: "Module"})
}));
