                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-md-6 table-responsive">
                            <table class="table">
                                ...
                                @if($property->sale_rent == "rent")
                                    <tr>
                                        <th scope="row">@lang('messages.is_it_furnished')</th>
                                        <td>{{$property->furniture}}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">@lang('messages.smoking')</th>
                        ...
                        <div class="col-md-6 table-responsive">
                            <table class="table">
                                ...
                                @if($property->sale_rent == "rent")
                                    <tr>
                                        <th scope="row">@lang('messages.animal')</th>
                                        <td>{{$property->animal}}</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <a href="/agents/{{$agent_info->user_id}}"
                               class="btn btn-second-main-color mt-3 text-white"
                               data-mdb-ripple-init>@lang('messages.agent_info')</a>
