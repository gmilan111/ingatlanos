        ...
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
            <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-white">
                    <h1 class="text-center h1-custom text-70">@lang('messages.registered_auctions')</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card border-0 shadow-custom text-black" style="width: 25rem;">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="properties/{{$property->id}}" class="btn btn-second-main-color mx-2 text-white"
                                   data-mdb-ripple-init><i
                                        class="fa-solid fa-circle-info"></i> @lang('messages.details')</a>
                                <!-- Button trigger modal -->
                                <a class="btn btn-second-main-color text-white" data-mdb-ripple-init
                                   href="/auctions/{{$property->id}}"><i
                                        class="fa-solid fa-eye"></i> @lang('messages.view_auction')</a>
                            </div>
                        </div>
                    </div>
                @else
